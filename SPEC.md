# Room-C Symphony Rust Implementation Note

This repository tracks the upstream OpenAI Symphony specification and implements it in Rust.

Upstream source: <https://github.com/openai/symphony/blob/main/SPEC.md>

Documented implementation differences live in `docs/adapting-spec.md`. The main intentional
extension is `tracker.kind: github`, with GitHub labels and GitHub Projects v2 modes mapped onto
the tracker contract in Section 11. Appendix A SSH workers remain out of scope for v0.1.
